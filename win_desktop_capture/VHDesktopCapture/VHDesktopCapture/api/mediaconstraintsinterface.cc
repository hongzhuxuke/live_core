...
const char MediaConstraintsInterface::kDegradationPreference[] = "DegradationPreference"; 
...
void CopyConstraintsIntoRtcConfiguration(
  ...
  ConstraintToOptional<int>(constraints,
                            MediaConstraintsInterface::kDegradationPreference,
                            &configuration->media_config.video.degradationPreference);
