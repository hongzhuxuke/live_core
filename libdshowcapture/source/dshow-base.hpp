...
#include "ComQIPtr.hpp"
#include "CoTaskMemPtr.hpp"

#include <string>
using namespace std;
#define DSHOWCAPTUREEXPORT __declspec(dllexport) 
...
DSHOWCAPTUREEXPORT bool GetFilterPin(IBaseFilter *filter, const GUID &type, const GUID &category,
